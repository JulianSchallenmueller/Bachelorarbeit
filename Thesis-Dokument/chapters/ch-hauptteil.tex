...
Pulumi bietet im Vergleich zu Terraform mehrere Vorteile, es gibt allerdings auch
diverse Nachteile die gegen den Einsatz von Pulumi sprechen.
Die folgenden Vorteile bietet Pulumi gegenüber Terraform:
...
\begin{itemize}
  ...
  \item \textbf{Provider Support:} TODO
  
  \item \textbf{State Management:} TODO
\end{itemize}

TODO: Pulumi gut, eventuell besser in Hinsicht auf DevOps dennoch Terraform weil:

\begin{itemize}
  \item \textbf{Modularität:} Terraforms Module erlauben es ein System in mehrere klar
  definierte Komponenten zu strukturieren, dadurch wird eine Wiederverwendbarkeit dieser
  ermöglicht. Die daraus resultierenden Vorteile wurden bereits in den vorangegangenen
  Kapiteln dargelegt, daher soll hier nicht weiter darauf eingegangen werden.

  \item \textbf{Ausgereiftheit:} Terraform hat den Vorteil die ältere 
  (Fußnote Terraform Release 2014 vs 2017 Pulumi) und auch ausgereiftere Option zu sein.
  TODO:

  \item \textbf{Weitere Verbreitung und größere Popularität:}
  -größere Community mehr Resourcen

  \item \textbf{Dokumentation:} Terraform verfügt über eine umfangreiche offizielle
  Dokumentation
\end{itemize}


- Warum Terraform statt Pulumi
- Hochwertige Dokumentation, breitere Verwendung, bessere Eignung für größere
  komplexere Projekte => tendenziell interessanter für große Organisationen
...
erstellt werden, zumindest Terraform selbst bietet (noch!) nicht die Option

\subsection{Terraform Grundprinzipien}
