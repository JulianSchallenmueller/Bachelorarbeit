...
\subsection{Zu untersuchende Aspekte und Eigenschaften}

\subsection{Entscheidungskriterien für die Evaluierung}

\subsection{Konkreter Aufbau in Microsoft Azure}

\subsection{Analyse Azure}

\subsection{Konkreter Aufbau in Amazon AWS}

\subsection{Analyse AWS}

\subsection{Konkreter Aufbau in Google Cloud Platform}

\subsection{Analyse GCP}



Das Ziel der Arbeit ist es einen Vergleich der Terraform Provider unter
möglichst gleichen Bedingugen zu erreichen. Da die durch die
verschiedenen Cloud Provider bereitgestellten Computing Ressourcen jedoch
...
Als Testobjekt dient ein Infrastruktursystem das typische Anwendungsfälle
...
Infrastruktur-Showcase der Novatec. Ergänzend zu diesem System sollen 
...
\section{Gemessene Werte und Erkenntnisse}
