...
\subsection{Evaluierung der Functional completeness}
...
einer Resource Group anzulegen.\\
...
Registry als Terraform Ressource zu erstellen, die Nutzung einer
bereits bestehenden Artifact Registry als Data Source ist jedoch
noch nicht möglich.

\subsection{Time behaviour Tests}
...
\begin{table}[H]
  ...
  \begin{tabular}{|p{0.22\linewidth}|p{0.35\linewidth}|p{0.35\linewidth}|}
    ...
    & Google Cloud Platform & Microsoft Azure\\
    \hline
    Aufbau Vollständiges Testsystem & 
    ...
    \hline
    Virtuelle Maschine mit Ubuntu 18.04, 30GB SSD, 2 vCPU und 4 GB RAM. &
...
\subsection{Recoverability Tests}
...
\subsection{Modifiability Tests}
...
\begin{table}[H]
  ...
  \begin{tabular}{|p{0.22\linewidth}|p{0.35\linewidth}|p{0.35\linewidth}|}
    ...
    \hline
    Vergrößerung eines Node Pools von 1 auf 2 Nodes &&\\
    \hline
  \end{tabular}
