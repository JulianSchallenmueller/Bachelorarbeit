...
\begin{itemize}
  ...
  und \enquote{Collation English\_United States.1252}
  \item Anlegen eines Secret Storage
  \item Anlegen eines Kubernetes Cluster
  \item Anlegen eines Node Pool für den Kubernetes Cluster
  \item Erfassen einer Container Image Registry als Data Source
  \item Installieren des Container Image im Node Pool des Kubernetes
  Cluster
\end{itemize}
...
\begin{itemize}
  ...
  \item Kubernetes Clusters ohne Node Pool
  \item Node Pool mit zwei Nodes
\end{itemize}

Es werden sowohl die Dauer für den Auf- als auch Abbau gemessen.
Jeder Test wird zehn mal wiederholt und der Mittelwert der
...
oder ähnliches führt.

\subsubsection{Co-existence}

Hier wird betrachtet wie viele Umgebungsvariablen gesetzt werden
müssen und wie allgemein oder spezifisch deren Namensgebung ausfällt.
Eine allgemeinere Namensgebung wie etwa
\textbf{\$CLOUD\_PLATFORM\_ACCOUNT} könnte eher zu unvorhergesehenen
Problemen führen als eine Namensgebung die ihren Zweck genau
spezifiziert.
...
Die untersuchten Szenarien entsprechen denen unter dem Punkt Time
behaviour:
...
\begin{itemize}
  ...
  \item Veränderung der statischen IP einer Virtuellen Maschine
  \item Veränderung des Project/Resourcegroup/...
